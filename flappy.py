...
background_image = pygame.image.load(os.path.join('C:\\Users\\micha\\OneDrive\\Desktop\\CS3305\\assets\\', 'BG1.png')).convert()
background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))

# Load moon image
moon_image = pygame.image.load(os.path.join('C:\\Users\\micha\\OneDrive\\Desktop\\CS3305\\assets\\', 'moon.png')).convert_alpha()
...
# Load floor image
floor_image = pygame.image.load(os.path.join('C:\\Users\\micha\\OneDrive\\Desktop\\CS3305\\tiles', '8.png')).convert()
